    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['asset_hub'], name='acq_broker__asset_h_7339f5_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'acq_photo',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['asset_hub'], name='acq_photo_asset_h_ef4ee0_idx'), models.Index(fields=['source_tag'], name='acq_photo_source__ceca6b_idx')],
            },
        ),
    ]
