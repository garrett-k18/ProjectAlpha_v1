    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('asset_hub', models.OneToOneField(blank=True, help_text='TEMP: nullable during staged migration; will be PK in next migration.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='internal_valuation', to='core.assetidhub')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=core.models.valuations.get_broker_document_path)),
                ('original_name', models.CharField(blank=True, max_length=255, null=True)),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('asset_hub', models.ForeignKey(blank=True, help_text='Stable hub ID (from broker_valuation.seller_raw_data.asset_hub).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='broker_documents', to='core.assetidhub')),
                ('broker_valuation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='core.brokervalues')),
            ],
            options={
                ...
                'indexes': [models.Index(fields=['broker_valuation'], name='acq_broker__broker__caad64_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source_raw_id', models.IntegerField(blank=True, db_index=True, help_text='Snapshot of SellerRawData.id', null=True)),
                ('image', models.ImageField(help_text='Uploaded image file.', upload_to=core.models.valuations.get_photo_path)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('asset_hub', models.ForeignKey(blank=True, help_text='Stable hub ID for this photo (from seller_raw_data.asset_hub).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='asset_photos', to='core.assetidhub')),
            ...
            options={
                ...
                'db_table': 'acq_photo',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['seller_raw_data'], name='acq_photo_seller__ed789e_idx'), models.Index(fields=['source_tag'], name='acq_photo_source__ceca6b_idx')],
            },
        ),
    ]
