# Generated by Django 5.2 on 2025-08-12 18:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'seller',
                'ordering': ['name'],
                'indexes': [models.Index(fields=['name'], name='seller_name_0007ce_idx')],
            },
        ),
        migrations.CreateModel(
            name='SellerRawData',
        ...
        migrations.AddIndex(
            model_name='trade',
            index=models.Index(fields=['seller'], name='trade_seller__46f401_idx'),
        ),
        migrations.AddIndex(
            model_name='sellerrawdata',
            index=models.Index(fields=['id'], name='seller_raw__id_479fdc_idx'),
        ),
        migrations.AddIndex(
            model_name='sellerrawdata',
            index=models.Index(fields=['asset_status'], name='seller_raw__asset_s_d348c6_idx'),
        ),
        migrations.AddIndex(
            model_name='sellerrawdata',
            index=models.Index(fields=['seller'], name='seller_raw__seller__22e60c_idx'),
        ),
        migrations.AddIndex(
            model_name='sellerrawdata',
            index=models.Index(fields=['trade'], name='seller_raw__trade_i_d98de9_idx'),
        ),
        migrations.AddIndex(
            model_name='sellerrawdata',
            index=models.Index(fields=['state'], name='seller_raw__state_fc80d2_idx'),
        ),
