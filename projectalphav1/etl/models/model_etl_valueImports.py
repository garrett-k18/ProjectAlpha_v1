...
class ValuationETL(models.Model):
    ...
    # Valuation metadata
    valuation_type = models.CharField(max_length=20, choices=ValuationType.choices, db_index=True, blank=True, null=True)
    bpo_type = models.CharField(max_length=20, choices=BpoType.choices, blank=True, null=True)

    # Property identification
    property_address = models.CharField(max_length=255, db_index=True, blank=True, null=True)
    city = models.CharField(max_length=100, blank=True, null=True)
    state = models.CharField(max_length=2, blank=True, null=True)
    zip_code = models.CharField(max_length=10, db_index=True, blank=True, null=True)
    parcel_number = models.CharField(max_length=100, blank=True, null=True, db_index=True)

    # Order/loan information
    loan_number = models.CharField(max_length=50, blank=True, null=True, db_index=True)
    deal_name = models.CharField(max_length=100, blank=True, null=True)

    # Dates
    inspection_date = models.DateField(db_index=True, blank=True, null=True)
    effective_date = models.DateField(blank=True, null=True)
    report_date = models.DateField(blank=True, null=True)

    # Property status
    occupancy_status = models.CharField(max_length=20, choices=Occupancy.choices, blank=True, null=True)
    property_appears_secure = models.BooleanField(default=True, null=True, blank=True)
    ...
    # Recent sale/listing
    sold_in_last_12_months = models.BooleanField(default=False, null=True, blank=True)
    ...
    currently_listed = models.BooleanField(default=False, null=True, blank=True)
    listing_broker = models.CharField(max_length=255, blank=True, null=True)
    listing_agent_email = models.EmailField(blank=True, null=True)
    listing_agent_firm = models.CharField(max_length=255, blank=True, null=True)
    ...
    listing_currently_pending = models.BooleanField(default=False, null=True, blank=True)
    ...
    foundation_type = models.CharField(max_length=30, choices=FoundationType.choices, blank=True, null=True)
    ...
    property_type = models.CharField(max_length=20, choices=PropertyTypeDetail.choices, blank=True, null=True)
    style = models.CharField(max_length=20, choices=Style.choices, blank=True, null=True)
    ...
    # Features (condensed)
    has_pool = models.BooleanField(default=False, null=True, blank=True)
    has_deck = models.BooleanField(default=False, null=True, blank=True)
    has_fireplace = models.BooleanField(default=False, null=True, blank=True)
    has_fencing = models.BooleanField(default=False, null=True, blank=True)
    garage = models.CharField(max_length=20, choices=Garage.choices, blank=True, null=True)
    ...
    cooling_type = models.CharField(max_length=50, choices=CoolingType.choices, blank=True, null=True)
    heating_type = models.CharField(max_length=50, choices=HeatingType.choices, blank=True, null=True)
    water_type = models.CharField(max_length=20, choices=WaterType.choices, blank=True, null=True)
    sewer_type = models.CharField(max_length=20, choices=SewerType.choices, blank=True, null=True)
    ...
    data_source_id = models.CharField(max_length=50, blank=True, null=True)
    ...
    estimated_marketing_time = models.CharField(max_length=20, choices=MarketingTime.choices, blank=True, null=True)
    typical_marketing_time_days = models.IntegerField(blank=True, null=True)
    recommended_sales_strategy = models.CharField(max_length=20, choices=SalesStrategy.choices, blank=True, null=True)
    ...
    # Appraisal specifics
    property_rights_appraised = models.CharField(max_length=20, choices=PropertyRights.choices, blank=True, null=True)
    ...
    # Market data
    financeable = models.CharField(max_length=50, blank=True, null=True)
    market_trend = models.CharField(max_length=20, choices=MarketTrend.choices, blank=True, null=True)
    neighborhood_trend = models.CharField(max_length=20, choices=MarketTrend.choices, blank=True, null=True)
    economic_trend = models.CharField(max_length=20, choices=MarketTrend.choices, blank=True, null=True)
    ...
    preparer_name = models.CharField(max_length=255, blank=True, null=True, help_text="Name of BPO agent or appraiser who prepared the valuation")
    preparer_company = models.CharField(max_length=255, blank=True, null=True, help_text="Company of the preparer")
    preparer_email = models.EmailField(blank=True, null=True, help_text="Email of the preparer")
    preparer_phone = models.CharField(max_length=50, blank=True, null=True, help_text="Phone number of the preparer")
    preparer_comments = models.TextField(blank=True, null=True, help_text="Comments or notes from the preparer")
...
class ComparablesETL(models.Model):
    ...
    comp_type = models.CharField(max_length=20, choices=CompType.choices, db_index=True, blank=True, null=True)
    ...
    # Transaction details
    sales_type = models.CharField(max_length=20, choices=SalesType.choices, blank=True, null=True)
    seller_concessions = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    financing_type = models.CharField(max_length=20, choices=FinancingType.choices, blank=True, null=True)
    ...
    has_fireplace = models.BooleanField(default=False, null=True, blank=True)
    has_fencing = models.BooleanField(default=False, null=True, blank=True)
    garage = models.CharField(max_length=20, blank=True, null=True)
    parking_spaces = models.IntegerField(blank=True, null=True)
    parking_type = models.CharField(max_length=50, blank=True, null=True)
    ...
    sewer_type = models.CharField(max_length=20, blank=True, null=True)
    hoa_fees_monthly = models.DecimalField(max_digits=8, decimal_places=2, blank=True, null=True)
    subdivision = models.CharField(max_length=255, blank=True, null=True)
    school_district = models.CharField(max_length=255, blank=True, null=True)
    ...
    total_adjustments = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, help_text="Total $ adjustments made to comparable")
...
class RepairItem(models.Model):
    ...
    repair_type = models.CharField(max_length=10, choices=RepairType.choices, blank=True, null=True)
    category = models.CharField(max_length=30, choices=RepairCategory.choices, blank=True, null=True)
    description = models.TextField(blank=True, null=True)
    estimated_cost = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    repair_recommended = models.BooleanField(default=False, blank=True, null=True, help_text="Whether this repair is recommended")
