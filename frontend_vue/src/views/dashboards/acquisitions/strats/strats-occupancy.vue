<template>
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      <div v-else-if="loadingOccupancy" class="d-flex align-items-center text-muted small py-3">
      ...
      <!-- Borderless grid-table: rows are occupancy categories -->
...
const { loadingOccupancy, errorOccupancy } = storeToRefs(strats)
...
async function ensureBands() {
  if (!hasBothSelections.value) return
  await strats.fetchBandsOccupancy(selectedSellerId.value as number, selectedTradeId.value as number)
}
