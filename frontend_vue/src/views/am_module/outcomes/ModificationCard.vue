...
function badgeClass(tp: ModificationTaskType): string {
  const map: Record<ModificationTaskType, string> = {
    mod_negotiations: 'badge rounded-pill text-bg-info',
    mod_accepted: 'badge rounded-pill text-bg-success',
    mod_started: 'badge rounded-pill text-bg-primary',
    mod_failed: 'badge rounded-pill text-bg-danger',
  }
  return map[tp]
}
