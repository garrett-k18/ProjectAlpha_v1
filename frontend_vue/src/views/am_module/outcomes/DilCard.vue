      ...
      <div class="col-lg-6">
        ...
        <form class="row g-2" @submit.prevent="onSave">
          ...
          <div class="col-6 d-flex align-items-end">
            <button type="submit" class="btn btn-primary ms-auto" :disabled="saveBusy">
              <span v-if="saveBusy" class="spinner-border spinner-border-sm me-2"></span>
              Save
            </button>
          </div>
        </form>
...
import { onMounted, computed, reactive, ref, withDefaults, defineProps, defineEmits } from 'vue'
...
async function onSave() {
  try {
    ...
    // PATCH to outcome pk; for OneToOne primary_key, pk equals hub id
