<template>
  <!--
    ProductDetailsContent renders the product details UI WITHOUT any outer layout or sidebar.
    This makes it suitable for embedding inside a modal as well as inside a full page wrapper.
  -->
  <div>
    <div class="card">
      <div class="card-body">
...
export default {
  ...
  // Props: pass row context and product id for future dynamic binding
  props: {
    row: {
...
<style scoped>
/* No component-specific styles required. Relies on Hyper UI + Bootstrap classes. */
</style>
