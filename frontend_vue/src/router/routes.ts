        ...
        children: [
            {
                ...
                path: 'acquisitions',
                meta: {authRequired: true},
                component: () => import('@/views/acq_module/acq_dash/index_acq_dash.vue'),
            },
            {
                name: 'Valuation Center',
                path: 'acquisitions/valuation-center',
                meta: {authRequired: true},
                component: () => import('@/views/acq_module/acq_dash/centers/ValuationCenter.vue'),
            },
            {
                name: 'Collateral Center',
                path: 'acquisitions/collateral-center',
                meta: {authRequired: true},
                component: () => import('@/views/acq_module/acq_dash/centers/CollateralCenter.vue'),
            },
            {
                name: 'Title Center',
            ...
            },
            {
                ...
                meta: {authRequired: true},
                component: () => import('@/views/etl/ImportMappingManager.vue'),
            },
            {
                name: 'Asset Mgmt',
                path: 'asset-mgmt',
