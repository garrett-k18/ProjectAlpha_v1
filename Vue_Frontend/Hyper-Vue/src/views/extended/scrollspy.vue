...
export default {
  ...
  mounted() {
    ...
    new ScrollSpy(document.getElementById<HTMLElement>("navbar-example1")!, {
      target: "#navbar-example2",
    });
    new ScrollSpy(document.getElementById<HTMLElement>("navbar-example4")!, {
      target: "#navbar-example3",
    });
    new ScrollSpy(document.getElementById<HTMLElement>("list-example1")!, {
